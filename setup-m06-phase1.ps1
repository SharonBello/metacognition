...
#   PS> Unblock-File .\setup-m06-phase1.ps1
#   PS> .\setup-m06-phase1.ps1
#   PS> npm install
#   PS> npm run dev
# ═══════════════════════════════════════════════════════════════════
...
Write-Host ""
Write-Host "M06 Phase 1 - full module (8 sections)" -ForegroundColor Magenta
Write-Host ""
...
export const SECTIONS: SectionMeta[] = [
  ...
  },
  {
    ...
    subtitleHe: 'תרגיל חי — תוצאה קצרה, חשיבה ארוכה. 90% מההוראה היא בלתי נראית.',
    minutes: 20,
  },
  {
    id: 'frameworks',
...
console.log('M06 build 2026-05-19-1');
...
const REASONS: Reason[] = [
  {
    number: '01',
    title: 'גודל ההשפעה — קרוב לפי שניים על שנה רגילה',
    body: 'במטא-אנליזה של ג׳ון האטי על למעלה מ-800 מחקרים, אסטרטגיות מטא-קוגניטיביות מקבלות גודל-השפעה של d ≈ 0.69 — הכפלה כמעט מלאה של ההתקדמות הצפויה בשנת לימוד. רק חזרה מרווחת ובדיקה עצמית מתחרות.',
...
.cardActive {
  ...
  .tagline { color: rgba(251, 251, 253, 0.85); }
  .when    { color: rgba(251, 251, 253, 0.65); }
}
...
.textarea {
  ...
  border-color: rgba(251, 251, 253, 0.18);
  color: $bg-canvas;
  line-height: $leading-loose;

  &::placeholder { color: rgba(251, 251, 253, 0.4); }
  &:focus {
    border-color: $accent;
...
// ═══════════════════════════════════════════════════════════════════
// M06 · Quiet Minimal Design Tokens
// Almost monochrome. Restrained. Typography-led.
// One accent (deep blue) used sparingly. "Reflective" feel — inward,
// dotted dividers, generous whitespace.
// ═══════════════════════════════════════════════════════════════════
